...
| [plan.md](specs/001-controle-financeiro/plan.md) | Stack e pastas (Next.js) |
...
| [research.md](specs/001-controle-financeiro/research.md) | Decisões (por que Next.js, Prisma, Auth.js) |
...
Comece pela **Phase 1** em `tasks.md` (setup da Natalia). Não implemente recorrência, PDF, PWA nem Open Finance nesta versão.
